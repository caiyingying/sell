...
public class DefaultHttpService implements HttpService {
  ...
  static {
    ...
    connectionManager.setMaxTotal(Config.HTTP_POOL_MAX_TOTAL);
    connectionManager.setDefaultMaxPerRoute(Config.HTTP_MAX_PER_ROUTE);

    defaultRequestConfig =
        RequestConfig.custom().setSocketTimeout(Config.HTTP_CONNECTION_TIMEOUT)
            .setConnectTimeout(Config.HTTP_CONNECTION_TIMEOUT)
            .setConnectionRequestTimeout(Config.HTTP_READ_TIMEOUT).build();
    httpClient =
  ...
  public String post(String url, Param... params) throws OpenException {
    ...
    if (params != null && params.length > 0) {
      ...
      post.setEntity(new UrlEncodedFormEntity(parameters, Charset.forName(Config.ENC_UTF8)));
    }
  ...
  private String httpExecute(HttpRequestBase request, String url) throws OpenException {
    ...
    try {
      ...
      return EntityUtils.toString(response.getEntity(), Config.ENC_UTF8);
